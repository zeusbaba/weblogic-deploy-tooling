...
OIM_CREDENTIALS = 'OIMCredentials'
OIM_KEYSTORE_USER = 'oim_keystore_user'
OIM_KEYSTORE_PASSWORD = 'oim_keystore_password'
OIM_SCHEMA_USER = 'oim_schema_user'
OIM_SCHEMA_PASSWORD = 'oim_schema_password'
OIM_SYSADMIN_USER = 'oim_sysadmin_user'
OIM_SYSADMIN_PASSWORD = 'oim_sysadmin_password'
OIM_WEBLOGICADMIN_USER = 'oim_weblogic_admin_user'
OIM_WEBLOGICADMIN_PASSWORD = 'oim_weblogic_admin_password'
